...
public class BlogController {
    ...
    @GetMapping
    public ResponseEntity<List<BlogPost>> getAllPublishedPosts(@RequestParam BlogPost.BlogStatus status) {
        List<BlogPost> posts = blogService.getAllPublishedPosts(status);
